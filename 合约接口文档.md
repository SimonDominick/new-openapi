...
| amount        | y        | int    | 数量                 |        |                                                              |
| beMaker       | n        | int    | 时间戳               | 0      | 被动委托：0:不被动委托 1:被动委托                            |
| detailSide    | y        | string | 仓位方向             |        | 1.开多open_long 2.开空open_short 3.平多close_long 4.平空close_short |
| startDate     | y        | string | 完成订单开始时间     |        | 毫秒Long                                                     |
| endDate       | y        | string | 完成订单结束时间     |        | 毫秒Long                                                     |
| status        | n        | string | 计划委托订单状态类型 |        | 0 未触发 1 已经触发 -1 已经撤销                              |
| expect Status | n        | string | 订单成交状态类型     |        | 0 等待成交 1 部分成交 2 已经成交 -1 已经撤销                 |
| systemType    | n        | string | 订单类型             |        | 10:限价 11:市价 12:计划委托 13:强平单 14:爆仓单              |
